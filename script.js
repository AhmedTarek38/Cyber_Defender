...
const gameData = {
    ...
    Specialist: [
        // 1. RED: Code Match
        { type: "Red", activityType: "code-match", maxScore: 2, selectedOption: null, title: "RED Challenge (1/5): Active Directory Reconnaissance", description: "Low-privilege access achieved. Best tool for **Active Directory Mapping and Analysis**? **Hint: Active Directory is a Microsoft service that manages user access and permissions on a network. Reconnaissance is the initial phase of gathering information about the target.**", snippet: "Goal: Find high-value targets in AD.", options: [{ text: "BloodHound (AD Mapping)", isCorrect: true, score: 2 }, { text: "Mimikatz (Credential Dumping)", isCorrect: false, score: 0 }, { text: "Wireshark (Local Traffic Capture)", isCorrect: false, score: 0 }, ], },
        // 2. GRC: Risk Assess
        { type: "GRC", activityType: "risk-assess", maxScore: 2, unit: "Impact Level", title: "GRC Challenge (2/5): PII Breach Severity", description: "An unpatched database holds all customer PII (GDPR regulation). Rate **Confidentiality Impact** (1-5). **Hint: PII (Personally Identifiable Information) is any data that can identify a specific individual. GDPR is a strict EU regulation governing data protection and privacy.**", correctValue: 5, },
